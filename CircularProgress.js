...
const CircularProgress = ({percent, radius, bgRingWidth, progressRingWidth, ringColor, ringBgColor,
  ...
  */
  ...
  return(
    <View style={[styles.container, {width: radius * 2, height: radius * 2, position:'absolute',
    left:(Dimensions.get('window').width/2 - radius),
    top:(Dimensions.get('window').height /2 - radius),}]}>
